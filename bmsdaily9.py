...
def get_venue_id(venue):
    ...
    if value is None:
        value = venue.get("venue_id")
    if value is None:
        value = venue.get("cinema_id")
    if value is None:
        value = venue.get("cinemaId")
    if value is None:
        return None
    try:
        return int(value)
...
#
# No source venue name lookup.
# No master venue lookup.
...
def main():
    ...
    # ========================================================
    # 1. LOAD districtvenues.json
    # ========================================================
    selected_venues = load_selected_venues()
    # ========================================================
    # 2. FETCH SOURCE DETAILED JSON
    # ========================================================
    source = fetch_source()
    if source is None:
